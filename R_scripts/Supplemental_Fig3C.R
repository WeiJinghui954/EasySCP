...
seurat_liver <- FindClusters(seurat_liver, resolution = 2.24, cluster.name = "clusters.mnn")

#  Create Heatmap Data
heatmap_data <- table(seurat_liver$clusters.mnn, seurat_liver$sample_labels)
custom_row_order <- c("1","5","4","3","9", "8", "6","7", "0", "2")
...
file_name <- "../Output/Figure/Supplemental Fig3C.png"
