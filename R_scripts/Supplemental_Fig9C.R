...
#  PCA
pca_coords <- Embeddings(seurat_liver, reduction = "integrated.mnn")
tmp_output <- data.frame(
...
ggsave(filename = "../Output/Figure/Supplemental Fig9C.png", plot = final_plot, width = 18, height = 20,limitsize = FALSE)
